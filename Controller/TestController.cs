...
public class TestController
{
    ...
    //
    // public TestController(IFoodRepository foodRepository, ITableRepository tableRepository, IWaiterRepository waiterRepository, IOrderRepository orderRepository)
    // {
